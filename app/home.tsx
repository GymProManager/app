...
import { View,Text,StyleSheet, Image, TextInput, Alert, ScrollView, useWindowDimensions } from "react-native";
                ...
                <View className="flex flex-col justify-center items-center mt-4"> 
                    <View className="flex flex-row w-full gap-2"> 
                            <View className="flex flex-col items-center w-1/2"> 
                                ...
                                />
                                <Text className="mt-4 text-white font-bold uppercase">Notifications</Text>
                            </View>
                            <View className="flex flex-col items-center w-1/2"> 
                                <Image
                                    ...
                                    className="bg-red-500"
                                />
                                <Text className="mt-4 text-white font-bold uppercase">Nutrición</Text>
                            </View>                        
                    </View>
                </View>
                <View className="flex flex-col justify-center items-center mt-4"> 
                    <View className="flex flex-row w-full gap-2"> 
                        <View className="flex flex-col items-center w-1/2"> 
                            ...
                            />
                            <Text className="mt-4 text-white font-bold uppercase">Servicios</Text>
                        </View>
                        <View className="flex flex-col items-center w-1/2"> 
                            <Image
                                style={ [styles.minibox, styles.boderLeft]}
                            ...
                            />
                            <Text className="mt-4 text-white font-bold uppercase">Cuestionarios</Text>
                        </View>                        
                    </View>
                </View>                           
            </View>                                       
