...
export default function OnboardingItem04() {
    ...
    return (
        <View className="relative flex flex-col items-center rounded-xl pt-8" style={[styles.colorBackground,styles.box]}> 
            <View className="relative flex flex-col items-center">
                ...
                <View className="w-full">
                    ...
                    plans.map((item: any) => {
                        return (
                        <View className="flex flex-col items-center mb-4" style={[ styles.card, item.color,{width: width-30}]} key={item.id} >
                            <ThemedText className="mb-4" >{item.description}</ThemedText>
                            <ThemedText  style={ styles.sizePrice } >{item.price} €/mes</ThemedText>
                        </View>
                        )
                    })
                    }
